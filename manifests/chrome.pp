...
class kiosk::chrome(
  ...
  $browser_path                         = "google-chrome --load-extension=/home/kiosk/.config/google-chrome/Default/Extensions/ --proxy-server=http://localhost:8080 --incognito --kiosk http://www.naturalis.nl/nl/het-museum/agenda/",
